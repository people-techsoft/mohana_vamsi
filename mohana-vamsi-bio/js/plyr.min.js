"object" == typeof navigator && function(e, t) {
    ...
    var g = function() {
        function t(n, i) {
            ...
            p.element(this.element) && p.empty(this.element.rangeTouch) && (this.config = Object.assign({}, o, i),
            this.init())
        }
        return n(t, [{
            key: "init",
            ...
            value: function(e) {
                if (!t.enabled || !p.event(e))
                    return null;
                var n, i = e.target, a = e.changedTouches[0], s = parseFloat(i.getAttribute("min")) || 0, o = parseFloat(i.getAttribute("max")) || 100, r = parseFloat(i.getAttribute("step")) || 1, l = o - s, c = i.getBoundingClientRect(), u = 100 / c.width * (this.config.thumbWidth / 2) / 100;
    ...
    function O(e, t, n) {
        ...
        return E.object(t) && _(i, t),
        E.string(n) && (i.innerText = n),
        i
    }
    function j(e, t, n, i) {
    ...
    function F(e, t) {
        return E.element(t) && E.element(t.parentNode) && E.element(e) ? (t.parentNode.replaceChild(e, t),
        e) : null
    }
    function H(e, t) {
        if (!E.string(e) || E.empty(e))
            return {};
        var n = {}
          , i = t;
    ...
    var Y, Q, X, J = (Y = document.createElement("span"),
    Q = {
    ...
    var G, Z = {
        ...
        rangeInput: (G = document.createElement("input"),
        G.type = "range",
        "range" === G.type),
                ...
                Object.defineProperty(e.media, "quality", {
                    ...
                    set: function(t) {
                        ...
                        if (n) {
                            ...
                            ("none" !== o || r) && (e.once("loadedmetadata", function() {
                                e.currentTime = a,
                                s || e.play()
                            }),
                            e.media.load()),
        ...
        cancelRequests: function() {
            this.isHTML5 && (q(ne.getSources.call(this)),
    ...
    function se() {
        ...
        return E.object(s) ? (Object.keys(s).forEach(function(t) {
            E.object(s[t]) ? (Object.keys(e).includes(t) || Object.assign(e, i({}, t, {})),
            se(e[t], s[t])) : Object.assign(e, i({}, t, s[t]))
        }),
    ...
    function be() {
        ...
        "".concat(n && e > 0 ? "-" : "").concat(a).concat(i(s), ":").concat(i(o))
    }
    var ke = {
        getIconUrl: function() {
        ...
        findElements: function() {
            try {
                ...
                E.element(this.elements.progress) && (this.elements.display.seekTooltip = this.elements.progress.querySelector(".".concat(this.config.classNames.tooltip))),
                !0
            } catch (e) {
        ...
        createIcon: function(e, t) {
            ...
            var s = document.createElementNS("http://www.w3.org/2000/svg", "use")
              , o = "".concat(i, "-").concat(e);
            return "href"in s && s.setAttributeNS("http://www.w3.org/1999/xlink", "href", o),
        ...
        createButton: function(e, t) {
            ...
            switch (["element", "icon", "label"].forEach(function(e) {
                Object.keys(n).includes(e) && (a[e] = n[e],
                delete n[e])
            }),
            "button" !== a.element || Object.keys(n).includes("type") || (n.type = "button"),
            ...
            case "play-large":
                ...
                break;
            default:
                E.empty(a.label) && (a.label = i),
                E.empty(a.icon) && (a.icon = e)
            }
            var s = O(a.element);
            ...
            _(s, n),
            "play" === i ? (E.array(this.elements.buttons[i]) || (this.elements.buttons[i] = []),
        ...
        updateVolume: function() {
            this.supported.ui && (E.element(this.elements.inputs.volume) && ke.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
            E.element(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
        },
        setRange: function(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0;
            E.element(e) && (e.value = t,
            ke.updateRangeFill.call(this, e))
        },
            ...
            if (this.supported.ui && E.event(e)) {
                ...
                if (e)
                    ...
                    case "seeked":
                        ...
                        "timeupdate" === e.type && ke.setRange.call(this, this.elements.inputs.seek, a);
                        break;
                    case "playing":
                    case "progress":
                        !function(e, n) {
            ...
            if (this.config.tooltips.seek && E.element(this.elements.inputs.seek) && E.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                ...
                if (this.touch)
                    ...
                    if (E.event(e))
                        ...
                        if (!V(this.elements.display.seekTooltip, a))
                            return;
                        n = parseFloat(this.elements.display.seekTooltip.style.left, 10)
                    }
                    n < 0 ? n = 0 : n > 100 && (n = 100),
                    ke.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * n),
                    this.elements.display.seekTooltip.style.left = "".concat(n, "%"),
                    E.event(e) && ["mouseenter", "mouseleave"].includes(e.type) && s("mouseenter" === e.type)
                }
            }
        },
        timeUpdate: function(e) {
            var t = !E.element(this.elements.display.duration) && this.config.invertTime;
            ke.updateTimeDisplay.call(this, this.elements.display.currentTime, t ? this.duration - this.currentTime : this.currentTime, t),
            e && "timeupdate" === e.type && this.media.seeking || ke.updateProgress.call(this, e)
        },
        durationUpdate: function() {
            if (this.supported.ui && (this.config.invertTime || !this.currentTime)) {
                if (this.duration >= Math.pow(2, 32))
                    return R(this.elements.display.currentTime, !0),
                ...
                !e && this.config.displayDuration && this.paused && ke.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
                e && ke.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
        ...
        updateSetting: function(e, t, n) {
            ...
            if (E.element(s) || (s = i && i.querySelector('[role="menu"]')),
            E.element(s)) {
        ...
        setQualityMenu: function(e) {
            ...
            if (E.element(this.elements.settings.panels.quality)) {
                ...
                if (ke.toggleMenuButton.call(this, "quality", i),
                D(n),
        ...
        setCaptionsMenu: function() {
            ...
            if (E.element(this.elements.settings.panels.captions)) {
                var t = this.elements.settings.panels.captions.querySelector('[role="menu"]')
                  ...
                  , i = Boolean(n.length);
                if (ke.toggleMenuButton.call(this, "captions", i),
                D(t),
                ke.checkMenu.call(this),
                i) {
        ...
        setSpeedMenu: function(e) {
            ...
            if (E.element(this.elements.settings.panels.speed)) {
                ...
                E.array(e) ? this.options.speed = e : (this.isHTML5 || this.isVimeo) && (this.options.speed = [.5, .75, 1, 1.25, 1.5, 1.75, 2]),
        ...
        toggleMenu: function(e) {
            ...
            if (E.element(t) && E.element(n)) {
                ...
                if (E.boolean(e))
                    a = e;
                else if (E.keyboardEvent(e) && 27 === e.which)
                    a = !1;
                else if (E.event(e)) {
                ...
                a && E.keyboardEvent(e) ? ke.focusFirstMenuItem.call(this, null, !0) : a || i || K.call(this, n, E.keyboardEvent(e))
            }
        },
        ...
        showMenuPanel: function() {
            ...
            if (E.element(i)) {
                ...
                R(s, !0),
                R(i, !1),
                ke.focusFirstMenuItem.call(this, i, n)
            }
        },
        ...
        create: function(e) {
            ...
            if (this.config.controls.includes("restart") && n.appendChild(ke.createButton.call(this, "restart")),
            this.config.controls.includes("rewind") && n.appendChild(ke.createButton.call(this, "rewind")),
            this.config.controls.includes("play") && n.appendChild(ke.createButton.call(this, "play")),
            this.config.controls.includes("fast-forward") && n.appendChild(ke.createButton.call(this, "fast-forward")),
            this.config.controls.includes("progress")) {
                ...
                n.appendChild(this.elements.progress)
            }
            if (this.config.controls.includes("current-time") && n.appendChild(ke.createTime.call(this, "currentTime")),
            this.config.controls.includes("duration") && n.appendChild(ke.createTime.call(this, "duration")),
            this.config.controls.includes("mute") || this.config.controls.includes("volume")) {
                var s = O("div", {
                    class: "plyr__volume"
                });
                if (this.config.controls.includes("mute") && s.appendChild(ke.createButton.call(this, "mute")),
            ...
            if (this.config.controls.includes("captions") && n.appendChild(ke.createButton.call(this, "captions")),
            this.config.controls.includes("settings") && !E.empty(this.config.settings)) {
                var r = O("div", {
                    class: "plyr__menu",
                    hidden: ""
                });
            ...
            if (this.config.controls.includes("pip") && te.pip && n.appendChild(ke.createButton.call(this, "pip")),
            this.config.controls.includes("airplay") && te.airplay && n.appendChild(ke.createButton.call(this, "airplay")),
            ...
            return this.config.controls.includes("fullscreen") && n.appendChild(ke.createButton.call(this, "fullscreen")),
            this.config.controls.includes("play-large") && this.elements.container.appendChild(ke.createButton.call(this, "play-large")),
            this.elements.controls = n,
            this.isHTML5 && ke.setQualityMenu.call(this, ne.getQualityOptions.call(this)),
        ...
        inject: function() {
            ...
            var i = {
              ...
              , s = !0;
            E.function(this.config.controls) && (this.config.controls = this.config.controls.call(this, i)),
            this.config.controls || (this.config.controls = []),
            E.element(this.config.controls) || E.string(this.config.controls) ? n = this.config.controls : (n = ke.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
            ...
            if (s && (E.string(this.config.controls) ? n = r(n) : E.element(n) && (n.innerHTML = r(n.innerHTML))),
            E.string(this.config.selectors.controls.container) && (o = document.querySelector(this.config.selectors.controls.container)),
            E.element(o) || (o = this.elements.container),
            o[E.element(n) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", n),
    ...
    var Ce = {
        setup: function() {
            if (this.supported.ui)
                if (!this.isVideo || this.isYouTube || this.isHTML5 && !te.textTracks)
                    E.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && ke.setCaptionsMenu.call(this);
                else {
                    var e, t;
                    if (E.element(this.elements.captions) || (this.elements.captions = O("div", H(this.config.selectors.captions)),
                    ...
                    if (E.boolean(o) || (o = this.config.captions.active),
        ...
        update: function() {
            ...
            (r && this.language !== a || !t.includes(o)) && (Ce.setLanguage.call(this, a),
            Ce.toggle.call(this, i && r)),
            B(this.elements.container, this.config.classNames.captions.enabled, !E.empty(t)),
            (this.config.controls || []).includes("settings") && this.config.settings.includes("captions") && ke.setCaptionsMenu.call(this)
        },
        toggle: function(e) {
            var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
            if (this.supported.ui) {
                ...
                if (a !== n) {
                    ...
                    L.call(this, this.media, a ? "captionsenabled" : "captionsdisabled")
                }
            }
        },
        set: function(e) {
        ...
        findTrack: function(e) {
            var t, n = this, i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], a = Ce.getTracks.call(this), s = function(e) {
        ...
        getLabel: function(e) {
            var t = e;
            return !E.track(t) && te.textTracks && this.captions.toggled && (t = Ce.getCurrentTrack.call(this)),
            E.track(t) ? E.empty(t.label) ? E.empty(t.language) ? he("enabled", this.config) : e.language.toUpperCase() : t.label : he("disabled", this.config)
        },
    ...
    function Ie() {
        ...
        Z.isIos) {
            ...
            t ? (this.cleanupViewport = !a,
            a || (n.content += ",".concat(i))) : this.cleanupViewport && (n.content = n.content.split(",").filter(function(e) {
                return e.trim() !== i
            }).join(",")),
            setTimeout(function() {
                return $(e.target)
    ...
    var _e = function() {
        function t(n) {
            ...
            N.call(this.player, document, "ms" === this.prefix ? "MSFullscreenChange" : "".concat(this.prefix, "fullscreenchange"), function() {
                Le.call(i)
            }),
        ...
        return n(t, [{
            ...
            key: "prefix",
            get: function() {
                if (E.function(document.exitFullscreen))
                    return "";
                var e = "";
                return ["webkit", "moz", "ms"].some(function(t) {
                    return !(!E.function(document["".concat(t, "ExitFullscreen")]) && !E.function(document["".concat(t, "CancelFullScreen")])) && (e = t,
                    !0)
                }),
                e
            }
    ...
    var je = {
        addStyleHook: function() {
            B(this.elements.container, this.config.selectors.container.replace(".", ""), !0),
            B(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
        },
        ...
        build: function() {
            ...
            E.element(this.elements.controls) || (ke.inject.call(this),
            ...
            B(this.elements.container, this.config.classNames.pip.supported, te.pip && this.isHTML5 && this.isVideo),
            B(this.elements.container, this.config.classNames.airplay.supported, te.airplay && this.isHTML5),
            B(this.elements.container, this.config.classNames.isIos, Z.isIos),
            B(this.elements.container, this.config.classNames.isTouch, this.touch),
            this.ready = !0,
            setTimeout(function() {
                L.call(e, e.media, "ready")
            }, 0),
            je.setTitle.call(this),
            this.poster && je.setPoster.call(this, this.poster, !1).catch(function() {}),
            this.config.duration && ke.durationUpdate.call(this)
        },
        setTitle: function() {
            var e = he("play", this.config);
            if (E.string(this.config.title) && !E.empty(this.config.title) && (e += ", ".concat(this.config.title)),
        ...
        setPoster: function(e) {
            ...
            .call(this).then(function() {
                ...
                throw e === t.poster && je.togglePoster.call(t, !1),
                n
            }).then(function() {
                if (e !== t.poster)
        ...
        checkPlaying: function(e) {
            var t = this;
            B(this.elements.container, this.config.classNames.playing, this.playing),
            B(this.elements.container, this.config.classNames.paused, this.paused),
            B(this.elements.container, this.config.classNames.stopped, this.stopped),
        ...
        return n(t, [{
            ...
            value: function() {
                var e = this.player
                  , t = e.elements;
                e.touch = !0,
                B(t.container, e.config.classNames.isTouch, !0)
            }
        }, {
            key: "setTabFocus",
            value: function(e) {
            ...
            value: function() {
                var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0]
                  , t = this.player;
                t.config.keyboard.global && P.call(t, window, "keydown keyup", this.handleKey, e, !1),
                P.call(t, document.body, "click", this.toggleMenu, e),
                x.call(t, document.body, "touchstart", this.firstTouch),
                P.call(t, document.body, "keydown focus blur", this.setTabFocus, e, !1, !0)
            }
        }, {
            key: "container",
            value: function() {
                var e = this.player
                  ...
                  , n = e.elements
                  , i = e.timers;
                !t.keyboard.global && t.keyboard.focused && N.call(e, n.container, "keydown keyup", this.handleKey, !1),
                N.call(e, n.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", function(t) {
                    var a = n.controls;
                        ...
                        !function(t, n, i) {
                            if (e.isVimeo) {
                                var s = e.elements.wrapper.firstChild
                                  ...
                                  , l = r[0]
                                  , c = r[1];
                                s.style.maxWidth = i ? "".concat(o / c * l, "px") : null,
                                s.style.margin = i ? "0 auto" : null
                            }
                        }(u.ratio, 0, c),
                        l || (c ? N.call(e, window, "resize", o) : M.call(e, window, "resize", o))
                    }
                })
            }
        }, {
            ...
            value: function() {
                ...
                N.call(t, t.media, "canplay loadeddata", function() {
                    R(n.volume, !t.hasAudio),
                    R(n.buttons.mute, !t.hasAudio)
                }),
            ...
            value: function() {
                ...
                this.bind(n.buttons.settings, "keyup", function(e) {
                    ...
                    e.stopPropagation(),
                    ke.toggleMenu.call(t, e)) : ke.focusFirstMenuItem.call(t, null, !0))
                }, null, !1),
    ...
    var Fe, He = (function(e, t) {
        e.exports = function() {
            ...
            function o(t, n, i, a) {
                var s, r, l = document, c = i.async, u = (i.numRetries || 0) + 1, d = i.before || e, h = t.replace(/^(css|img)!/, "");
                a = a || 0,
                /(^css!|\.css$)/.test(t) ? ((r = l.createElement("link")).rel = "stylesheet",
                r.href = h,
                (s = "hideFocus"in r) && r.relList && (s = 0,
                r.rel = "preload",
                r.as = "style")) : /(^img!|\.(png|gif|jpg|svg)$)/.test(t) ? (r = l.createElement("img")).src = h : ((r = l.createElement("script")).src = t,
                r.async = void 0 === c || c),
            ...
            function r(e, n, i) {
                ...
                function c(t, n) {
                    !function(e, t, n) {
                        var i, a, s = (e = e.push ? e : [e]).length, r = s, l = [];
    ...
    var Ve = {
        setup: function() {
            ...
            qe.call(this),
            E.object(window.Vimeo) ? Ve.ready.call(this) : Re(this.config.urls.vimeo.sdk).then(function() {
                Ve.ready.call(e)
            }).catch(function(t) {
        ...
        ready: function() {
            ...
            var o, r = (o = s,
            E.empty(o) ? null : E.number(Number(o)) ? o : o.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : o), l = O("iframe"), c = oe(t.config.urls.vimeo.iframe, r, i);
    ...
    var ze, We = {
        setup: function() {
            ...
            B(this.elements.wrapper, this.config.classNames.embed, !0),
            qe.call(this),
            E.object(window.YT) && E.function(window.YT.Player) ? We.ready.call(this) : (Re(this.config.urls.youtube.sdk).catch(function(t) {
        ...
        ready: function() {
            ...
            if (E.empty(t) || !t.startsWith("youtube-")) {
                ...
                var i, a, s = (i = n,
                E.empty(i) ? null : i.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : i), o = (a = e.provider,
                "".concat(a, "-").concat(Math.floor(1e4 * Math.random()))), r = O("div", {
                    id: o,
                    poster: e.poster
                });
                e.media = F(r, e.media);
                    ...
                    events: {
                        ...
                        onStateChange: function(t) {
                            ...
                            case 0:
                                ...
                                break;
                            case 1:
                                e.media.paused && !e.embed.hasPlayed ? e.media.pause() : (Ue.call(e, !0),
        ...
        setup: function() {
            this.media ? (B(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
            B(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0),
            this.isEmbed && B(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
            ...
            this.isHTML5 ? ne.extend.call(this) : this.isYouTube ? We.setup.call(this) : this.isVimeo && Ve.setup.call(this)) : this.debug.warn("No media element found!")
        }
    }, Ye = function() {
        function t(n) {
            var i = this;
        ...
        return n(t, [{
            ...
            key: "on",
            value: function(e, t) {
                return E.array(this.events[e]) || (this.events[e] = []),
            ...
            value: function(e) {
                E.nullOrUndefined(this.safetyTimer) || (this.player.debug.log("Safety timer cleared from: ".concat(e)),
        ...
        return n(t, [{
                            ...
                            s.split(/\r\n\r\n|\n\n|\r\r/).forEach(function(e) {
                                ...
                                e.split(/\r\n|\n|\r/).forEach(function(e) {
                                    if (E.number(t.startTime)) {
                                        ...
                                        o && (t.startTime = 60 * Number(o[1]) * 60 + 60 * Number(o[2]) + Number(o[3]) + Number("0.".concat(o[4])),
                                        t.endTime = 60 * Number(o[6]) * 60 + 60 * Number(o[7]) + Number(o[8]) + Number("0.".concat(o[9])))
                                    }
                                }),
                                t.text && o.push(t)
                            }),
            ...
            value: function() {
                var e = this;
                this.mouseDown = !1,
                Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime) ? this.toggleScrubbingContainer(!1) : x.call(this.player, this.player.media, "timeupdate", function() {
        ...
        change: function(e) {
            var t = this;
            ae(e, "sources.length") ? (ne.cancelRequests.call(this),
            this.destroy.call(this, function() {
                t.options.quality = [],
                q(t.media),
                t.media = null,
                E.element(t.elements.container) && t.elements.container.removeAttribute("class");
                var n = e.sources
                  , i = e.type
                  , s = a(n, 1)[0]
                  , o = s.provider
                ...
                Ke.setup.call(t),
                t.isHTML5 && Object.keys(e).includes("tracks") && Xe.insertElements.call(t, "track", e.tracks),
                (t.isHTML5 || t.isEmbed && !t.supported.ui) && je.build.call(t),
        ...
        function t(n, i) {
            ...
            (window.jQuery && this.media instanceof jQuery || E.nodeList(this.media) || E.array(this.media)) && (this.media = this.media[0]),
            this.config = se({}, Ae, t.defaults, i || {}, function() {
                try {
                ...
                if (this.media.plyr)
                    ...
                    if (te.check().api) {
                        ...
                        case "div":
                            ...
                            if (E.empty(this.provider) || !Object.keys(Pe).includes(this.provider))
                        ...
                        this.supported = te.check(this.type, this.provider, this.config.playsinline),
                        this.supported.api ? (this.eventListeners = [],
                        this.listeners = new De(this),
                        this.storage = new me(this),
                        this.media.plyr = this,
                        E.element(this.elements.container) || (this.elements.container = O("div", {
                            tabindex: 0
                        }),
                        I(this.media, this.elements.container)),
                        je.addStyleHook.call(this),
                        Ke.setup.call(this),
                        this.config.debug && N.call(this, this.elements.container, this.config.events.join(" "), function(e) {
                        ...
                        this.lastSeekTime = 0,
                        this.config.previewThumbnails.enabled && (this.previewThumbnails = new Qe(this))) : this.debug.error("Setup failed: no support")
                    } else
        ...
        return n(t, [{
            ...
            value: function() {
                ...
                this.restart()) : E.function(this.media.stop) && this.media.stop()
            }
        }, {
            key: "restart",
            value: function() {
            ...
            value: function(e) {
                if (this.supported.ui && !this.isAudio) {
                    ...
                    if (i && this.config.controls.includes("settings") && !E.empty(this.config.settings) && ke.toggleMenu.call(this, !1),
                    i !== t) {
            ...
            value: function(e) {
                ...
                if (this.ready) {
                    var i = function() {
                        ...
                        t.embed = null,
                        n ? (Object.keys(t.elements).length && (q(t.elements.buttons.play),
            ...
            set: function(e) {
                if (te.pip) {
                    ...
                    E.function(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(t ? Ee : Se),
                    E.function(this.media.requestPictureInPicture) && (!this.pip && t ? this.media.requestPictureInPicture() : this.pip && !t && document.exitPictureInPicture())
                }
            },
            get: function() {
            ...
            value: function(e) {
                var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                  , i = null;
                return E.string(e) ? i = Array.from(document.querySelectorAll(e)) : E.nodeList(e) ? i = Array.from(e) : E.array(e) && (i = e.filter(E.element)),
                E.empty(i) ? null : i.map(function(e) {
                    return new t(e,n)
                })
            }
        }]),
